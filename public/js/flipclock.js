...
(function($) {
	...
	FlipClock.DailyCounterFace = FlipClock.Face.extend({
		...
		build: function(excludeHours, time) {
			...
			$(this.createDivider('分')).insertBefore(this.factory.lists[this.factory.lists.length - 4 + offset].$obj);
			$(this.createDivider('时')).insertBefore(this.factory.lists[this.factory.lists.length - 6 + offset].$obj);
			$(this.createDivider('天', true)).insertBefore(this.factory.lists[0].$obj);
